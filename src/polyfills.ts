 ...
 *
 * This file is divided into 2 sections: 1. Browser polyfills. These are
 * applied before loading ZoneJS and are sorted by browsers.  2. Application
 * imports. Files imported after ZoneJS that should be loaded before your main
 * file.
 *
...
/** Web Animations `@angular/platform-browser/animations` Only required if
 * AnimationBuilder is used within the application and using IE/Edge or Safari.
